...
class RysObjectiveCLexer(RegexLexer):
	...
	- Changed keyword values from Name.Built to Keyword.Constant and added a few:
		- YES
		- NO
		- Nil
    ...
    tokens = {
        ...
        'statements': [
            ...
            (r'(\[)([a-zA-Z$_][a-zA-Z0-9$_]*)(\s+)([a-zA-Z$_][a-zA-Z0-9$_]*)(\])',
            ...
            (r'(auto|break|case|continue|default|do|else|enum|extern|'
			 ...
			 r'@protocol|@blc|copy|nonatomic|readonly|readwrite|strong|weak|getter|setter)\b', Keyword),
			# Custom typedefs used in my tutorials (shouldn't really be here...)
			(r'SpeedFunction', Keyword.Type),
            (r'(int|long|float|short|double|char|unsigned|signed|void|'
             r'id|BOOL|IBOutlet|IBAction|SEL|Class|__block|__weak|unichar|'
             r'int8_t|uint8_t|int16_t|uint16_t|int32_t|uint32_t|int64_t|uint64_t|'
             r'int_least8_t|uint_least8_t|int_least16_t|uint_least16_t|'
			 r'int_least32_t|uint_least32_t|int_least64_t|uint_least64_t|'
			 r'intmax_t|uintmax_t|intptr_t|uintptr_t|size_t|'
			 r'__strong|const|static)\b', Keyword.Type),
        ...
        'root': [
            ...
            (r'((?:[a-zA-Z0-9_*\s])+?(?:\s|[*]))'    # return arguments
             ...
             bygroups(using(this), Name.Function,
                      using(this), Text, Punctuation)),
            (r'(@interface|@implementation|@protocol)(\s+)', bygroups(Keyword, Text),
             'classname'),
        ...
        'macro': [
            (r'(import|define)(\s+)(.*)', bygroups(Comment.Preproc, Text, Literal)),
            (r'[^/\n]+', Comment.Preproc),
            (r'/[*](.|\n)*?[*]/', Comment.Multiline),
            (r'//.*?\n', Comment.Single, '#pop'),
            (r'/', Comment.Preproc),
